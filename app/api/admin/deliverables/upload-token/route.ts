  ...
  try {
    const jsonResponse = await handleUpload({
      ...
      onBeforeGenerateToken: async () => ({
        allowedContentTypes: ["image/png", "image/jpeg", "image/jpg", "image/webp", "image/gif", "image/avif", "image/bmp", "application/pdf"],
    ...
    console.error("[deliverables] client upload error:", error);
