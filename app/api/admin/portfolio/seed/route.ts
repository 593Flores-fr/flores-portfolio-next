...
const DEFAULT_PROJECTS = [
  {
    ...
    tag: "Direction artistique · 2024", sectionName: "Visuel", year: "2024",
  ...
  },
  {
    ...
    tag: "Branding & Dev Web · 2024", sectionName: "Web", year: "2024",
  ...
  },
  {
    ...
    tag: "Identité visuelle · 2024", sectionName: "Visuel", year: "2024",
  ...
  },
  {
    ...
    tag: "Charte graphique · 2024", sectionName: "Visuel", year: "2024",
  ...
  },
  {
    ...
    tag: "Projet associatif · 2024", sectionName: "Visuel", year: "2024",
  ...
  },
  {
    ...
    tag: "Covers musicales · 2021–2024", sectionName: "Cover", year: "2021–2024",
...
export async function POST() {
  ...
  const sectionIdByName = Object.fromEntries(sections.map(s => [s.name, s.id]));

  const results = [];
  for (const p of DEFAULT_PROJECTS) {
    const exists = await prisma.portfolioProject.findUnique({ where: { slug: p.slug } });
    if (!exists) {
      const { sectionName, ...rest } = p;
      const created = await prisma.portfolioProject.create({
        data: {
          ...
          images: [],
          sectionId: sectionIdByName[sectionName] ?? null,
