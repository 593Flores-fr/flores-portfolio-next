  ...
  return (
    ...
    >
      <div
        ...
        onKeyDown={onKeyDown}
      >
        <div className="pointer-events-none absolute inset-x-0 top-6 mx-auto h-48 w-[70%] rounded-full blur-3xl" style={{ background: "rgba(255,255,255,0.03)" }} aria-hidden />
        <div className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto h-40 w-[76%] rounded-full blur-3xl" style={{ background: "rgba(0,0,0,0.3)" }} aria-hidden />
            ...
            {items.map((it, idx) => (
              <button
                ...
                style={{
                  ...
                  height: "8px",
                  borderRadius: "999px",
                  background: idx === active ? "rgba(255,255,255,0.8)" : "rgba(255,255,255,0.2)",
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-6">
        ...
        <p style={{ fontFamily: "var(--font-poppins)", fontSize: "16px", fontWeight: 600, color: "white", marginBottom: item.description ? "4px" : "0" }}>
          {item.title}
        </p>
        {item.description && (
